...
class AppStringsZh extends AppStrings {
  ...
  static const _text = <String, String>{
    ...
    'setupTitle': '创建主密码',
    'setupSubtitle': '主密码不会上传，也无法找回。请务必牢记。',
    ...
    'cloudConnected': '已连接',
    'cloudRegisteredConnected': '已注册并连接',
    'cloudSyncConflictsDetected': '检测到同步冲突；已导入',
    'cloudEncryptedUpdates': '条加密更新',
    'cloudUnresolvedConflicts': '个未解决冲突',
    'cloudSyncedImported': '已同步；已导入',
    'cloudDownloadedImported': '已下载并导入',
    'cloudEncryptedRecords': '条加密记录',
    'cloudDeviceCountSuffix': '台云端设备',
    'cloudDeviceRenamed': '设备已重命名',
    'cloudDeviceRevoked': '设备已撤销',
    'cloudUnavailable': '云同步不可用',
    'cloudLoginRequired': '请先登录云同步账户。',
    'cloudRegisterValidationError': '注册信息不符合要求，请检查邮箱格式和至少 12 位云账号密码。',
    'cloudInvalidCredentials': '邮箱或云账号密码错误。',
    'cloudUserDisabled': '云账号已被禁用。',
    'cloudNetworkFailed': '无法连接云同步服务，请检查后端地址和网络。',
    'cloudActionFailed': '云同步操作失败，请稍后重试。',
    'cloudSyncVaultTitle': '同步加密密码库',
    'cloudSync': '同步',
    'cloudDownloadVaultTitle': '下载云端密码库',
    ...
    'cloudSyncTitle': '云同步',
    'cloudSyncSubtitle': '通过后端账户同步加密密码库数据。',
    'cloudSyncStatus': '云同步状态',
    'cloudLogin': '云端登录',
    'cloudLoginSubtitle': '使用单独的后端账户密码。',
    'cloudRegister': '注册云端账户',
    'cloudRegisterSubtitle': '创建用于同步的后端账户。',
    'cloudDownloadVault': '下载云端密码库',
    'cloudDevices': '云端设备',
    'cloudDevicesSubtitle': '查看此账户的受信任设备。',
    'cloudLogout': '退出云同步',
    'cloudLogoutSubtitle': '清除此设备上的云端令牌。',
    'lanExchangeTitle': '局域网交换',
    'lanExchangeSubtitle': '在附近设备之间直接传输加密的密码库数据。',
    'lanSendData': '发送数据',
    'lanSendDataSubtitle': '为当前密码库创建本地传输 QR 码。',
    'lanReceiveData': '接收数据',
    'lanReceiveDataSubtitle': '扫描或粘贴本地传输内容。',
    ...
    'cloudMasterPasswordPromptSubtitle': '请输入本地主密码处理加密同步数据；主密码不会上传或保存到后端。',
    'localOnlyInfo': '信息仅存储在本机',
    ...
    'syncConflicts': '同步冲突',
    'downloadLatestEncryptedVault': '下载最新加密密码库',
    'masterPasswordConfirmationFailed': '主密码确认失败',
    'cloudDownloadFailed': '云端下载失败',
    'confirmMasterPasswordTitle': '确认主密码',
    ...
    'conflictStateUnavailable': '冲突状态不可用',
    'noUnresolvedConflicts': '没有未解决冲突',
    'deviceListUnavailable': '设备列表不可用',
    'noCloudDevicesConnected': '没有已连接的云端设备',
    'emergencyAccessUnavailable': '紧急访问不可用',
    'deviceTrust': '设备信任',
    ...
    'passkeyMetadata': '通行密钥元数据',
    'addPasskeyMetadata': '添加通行密钥元数据',
    'editMetadata': '编辑元数据',
    'relyingPartyId': '信赖方 ID',
    'rpId': '信赖方 ID',
    'credential': '凭据',
    'user': '用户',
    'display': '显示名称',
    ...
    'emergencyKeyGenerationFailed': '紧急访问密钥生成失败',
    'emergencyContactRequiredFields': '邮箱、公钥和指纹为必填项',
    'emergencyContactKeyRejected': '联系人密钥信息不被接受',
    'emergencyContactCreationFailed': '联系人创建失败',
    'emergencyContactRevokeFailed': '联系人撤销失败',
    'emergencyChooseActiveContact': '请选择一个活动联系人',
    'emergencyWaitingPeriodInvalid': '等待期必须为 1 到 2160 小时',
    'emergencyRecoveryPlaintextRequired': '恢复包明文为必填项',
    'emergencyRecoveryPlaintextTooLarge': '恢复包明文必须不超过 64 KiB',
    'emergencyGrantCreationFailed': '授权创建失败',
    'emergencyGrantAcceptFailed': '授权接受失败',
    'emergencyAccessRequestFailed': '访问请求失败',
    'emergencyCancelFailed': '取消失败',
    'emergencyGrantRevokeFailed': '授权撤销失败',
    'emergencyPackageDownloadFailed': '访问包下载失败',
    'emergencyHeaderSubtitle': '管理恢复联系人、加密授权和本地接收方访问包解密。',
    ...
    'cloudSyncMissingDetail': '云同步未连接，或缺少本地同步状态。',
    'unresolvedConflict': '个未解决冲突',
    'syncNoPendingConflictsDetail': '本地加密同步状态没有待处理冲突记录。',
    'syncReviewMetadataDetail': '查看安全元数据，并在准备好后下载最新加密密码库。',
    'deviceTrustSignInDetail': '登录云同步后可查看受信任设备。',
    'activeDevicesTrusted': '台活动设备受信任',
    'deviceCanRegisterAfterSignIn': '登录后，云同步可以注册此设备。',
    'deviceRiskSummarySuffix': '个风险指标：',
    'untrustedDevices': '未受信任',
    'missingDeviceMetadata': '缺少元数据',
    'staleDeviceSync': '同步过期',
    'emergencyMetadataUnavailableDetail': '云同步未连接，或紧急访问元数据不可用。',
    'revokedStatus': '已撤销',
    'emergencyStatusActive': '活动',
    'emergencyStatusRevoked': '已撤销',
    'emergencyStatusPendingAcceptance': '待接受',
    'emergencyStatusAccessRequested': '已请求访问',
    'emergencyStatusReadyForDownload': '可下载',
    'emergencyStatusCancelled': '已取消',
    'emergencyStatusDownloaded': '已下载',
    'waitingHoursSuffix': '小时等待',
    'activeContactCount': '个活动联系人',
    'configuredGrantCount': '个授权已配置用于延迟恢复。',
    ...
    'roadmapEmergencyDetail': '恢复联系人和延迟访问。',
    'emergencyLoading': '正在加载紧急访问',
    'revokeContact': '撤销联系人',
    'revokeContactMessage': '撤销此联系人的紧急访问设置？',
    'acceptEmergencyGrant': '接受紧急授权',
    'recipientKeyFingerprint': '接收方密钥指纹',
    'cancelRequest': '取消请求',
    'cancelRequestMessage': '取消待处理的紧急访问请求？',
    'revokeGrant': '撤销授权',
    'revokeGrantMessage': '撤销此紧急授权？',
    'recipientSetupKey': '接收方设置密钥',
    'generateLocalKeyPair': '生成本地密钥对',
    'publicKey': '公钥',
    'fingerprint': '指纹',
    'privateKeyLocalOnly': '私钥（仅本机）',
    'createContact': '创建联系人',
    'recipientEmail': '接收方邮箱',
    'recipientPublicKey': '接收方公钥',
    'optionalLabel': '标签（可选）',
    'createEncryptedGrant': '创建加密授权',
    'activeContact': '当前联系人',
    'waitingPeriodHours': '等待期（小时）',
    'localRecoveryPackagePlaintext': '本地恢复包明文',
    'localRecoveryPackageHelper': '最大 64 KiB。提交后会清除。',
    'encryptAndCreateGrant': '加密并创建授权',
    'contacts': '联系人',
    'contactsUnavailable': '紧急联系人不可用',
    'noContacts': '没有紧急联系人',
    'grants': '授权',
    'grantsUnavailable': '紧急授权不可用',
    'noGrants': '没有紧急授权',
    'accept': '接受',
    'requestAccess': '请求访问',
    'localDecryptFailed': '本地解密失败',
    'emergencyPackage': '紧急访问包',
    'grant': '授权',
    'packageFingerprint': '包指纹',
    'recipientPrivateKeyLocalOnly': '接收方私钥（仅本机）',
    'decryptLocally': '本地解密',
    'decryptedPackage': '已解密包',
    'packageAad': '包 AAD',
    'encryptedPackageEnvelope': '加密包信封',
  };
